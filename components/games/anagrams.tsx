...
const WORD_PAIRS = [
  { word: 'BOX', anagrams: ['OBX', 'OCA', 'OXV', 'OBP'] },
  { word: 'STOP', anagrams: ['POTS', 'TOPS', 'SPOT', 'POST'] },
  { word: 'TEAM', anagrams: ['MATE', 'TAME', 'MEAT', 'TEAT'] },
  { word: 'RATE', anagrams: ['TEAR', 'TARE', 'TREA', 'TEER'] },
  { word: 'SEAT', anagrams: ['EAST', 'SATE', 'TASE', 'TEAS'] },
  { word: 'PART', anagrams: ['TRAP', 'TARP', 'RAPT', 'PRAT'] },
  { word: 'STAR', anagrams: ['TARS', 'RATS', 'ARTS', 'TRAS'] },
  { word: 'LEAP', anagrams: ['PALE', 'PLEA', 'PEAL', 'ALEP'] },
  { word: 'TIME', anagrams: ['ITEM', 'MITE', 'EMIT', 'TIEM'] },
  { word: 'CARE', anagrams: ['RACE', 'ACRE', 'CERA', 'CREA'] },
];
...
export function AnagramsGame() {
  ...
  const generateGame = () => {
    ...
    const options = [...randomPair.anagrams];
